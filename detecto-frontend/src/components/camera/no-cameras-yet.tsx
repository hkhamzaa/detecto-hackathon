 ...
 * empty.
 */
export function NoCamerasYet({ lead = DEFAULT_LEAD }: { lead?: string }) {
  return (
    <Panel label="No cameras yet">
      <PanelBody>
        <p className="max-w-2xl text-body text-neutral-700">{lead}</p>
        ...
        <p className="mt-5 max-w-2xl border-t border-neutral-200 pt-4 text-meta text-neutral-500">
          Connecting a camera does not switch detection on. That is a separate,
          deliberate step, and nothing is watched for weapons or violence until
          you take it.
        </p>
      </PanelBody>
    </Panel>
